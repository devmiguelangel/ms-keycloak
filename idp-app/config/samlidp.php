...
return [
    ...
    'sp' => [
        ...
        //     'encrypt_assertion' => false
        // ]
        'aHR0cHM6Ly9rZXljbG9hay5wcm9jZXNzbWFrZXIubmV0L3JlYWxtcy9jdXN0b21lcjEvYnJva2VyL3NhbWwvZW5kcG9pbnQ=' => [
            'destination' => 'https://keycloak.processmaker.net/realms/customer1/broker/saml/endpoint',
            'logout' => '',
            'certificate' => '',
            'query_params' => false,
            'encrypt_assertion' => false,
